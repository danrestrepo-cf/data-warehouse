...
SET breo_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
						  WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
		END
...
SET bres_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
						  WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
		END
	, bres_current = FALSE
...
SET btf_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
						 WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
		END
...
SET data_source_updated_datetime = NOW()
	, etl_batch_id = 'rtd-11-1201696010784016'
	, dtg_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
						 WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
	END
FROM history_octane.deal
...
SET ri_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
						WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
		END
