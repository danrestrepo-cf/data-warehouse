...
SET b_alimony_child_support = 'UNKNOWN'
  ...
  , b_mailing_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
                               WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
    END
  , b_middle_name = ''
  , b_mobile_phone = ''
  , b_name_suffix = ''
...
SET baa_credit_report_identifier = ''
  , baa_reported_year = 0
...
SET bdec_fha_secondary_residence = 'UNKNOWN'
...
SET
    breo_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
                          WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
        END
...
SET
    bres_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
                          WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
        END
  , bres_current = FALSE
...
SET
    btf_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
                         WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
        END
...
SET crdr_requester_unparsed_name = ''
...
SET crl_credit_report_identifier = ''
...
SET d_deal_status_type = 'CANCELLED'
  , d_hmda_action_date = CURRENT_DATE
  , d_hmda_action_type = 'WITHDRAWN'
WHERE deal.d_los_loan_id_main IN (1401318407, 1401487039);


-- deal_invoice
UPDATE history_octane.deal_invoice
SET di_create_datetime = NULL
  , di_invoice_amount = 0
  , di_refund_amount = 0
  , di_description = ''
  , di_internal_notes = ''
...
SET dtg_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
                         WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
    END
FROM history_octane.deal
...
SET dur_requester_unparsed_name = ''
  , dur_mp_status_log = ''
  , dur_loan_amount = 0
...
SET lh_effective_credit_score = 0
  , lh_debt_to_income = 0
  , lh_note_date = NULL
...
SET lpr_requester_unparsed_name = ''
  , lpr_loan_amount = 0
...
SET oi_estimated_net_income_amount = 0
...
SET prp_smart_docs_enabled = FALSE
  , prp_note_date = NULL
...
SET prpd_deal_child_name = ''
  , prpd_reo_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
                              WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
    END
  , prpd_property_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
                                   WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
    END
  , prpd_residence_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
                                    WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
    END
...
SET prpds_creator_unparsed_name = ''
...
SET prpr_fulfill_status_unparsed_name = ''
  , prpr_decision_status_unparsed_name = ''
  , prpr_reo_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
                              WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
    END
  , prpr_property_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
                                   WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
    END
  , prpr_residence_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
                                    WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
    END
...
SET
    ri_place_pid = CASE WHEN deal.d_los_loan_id_main = 1401487039 THEN 66955894
                        WHEN deal.d_los_loan_id_main = 1401318407 THEN 66955927
        END
...
SET ttr_requester_unparsed_name = ''
  , ttr_company_name = ''
  , ttr_company_city = ''
  , ttr_company_country = ''
