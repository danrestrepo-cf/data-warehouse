...
from lib.config_mdi_metadata_maintenance.metadata_comparison_functions import InsertUpdateStepMetadataComparisonFunctions


class TestInsertUpdateStepMetadataComparisonFunctions(unittest.TestCase):
    ...
    def test_construct_metadata_table_from_config_db(self):
        ...
        self.assertEqual(expected, InsertUpdateStepMetadataComparisonFunctions().construct_metadata_table_from_config_db(db_conn))
    ...
    def test_construct_metadata_table_from_source(self):
        ...
        self.assertEqual(expected, InsertUpdateStepMetadataComparisonFunctions().construct_metadata_table_from_source(dw_metadata))
    ...
    def test_construct_insert_row_grouper(self):
        ...
        row_grouper = InsertUpdateStepMetadataComparisonFunctions().construct_insert_row_grouper(
    ...
    def test_construct_delete_row_grouper(self):
        ...
        row_grouper = InsertUpdateStepMetadataComparisonFunctions().construct_delete_row_grouper(MetadataTable([]))
        self.assertEqual([test_data], row_grouper.group_rows(test_data))
    ...
    def test_generate_insert_sql(self):
        ...
        self.assertEqual(expected, InsertUpdateStepMetadataComparisonFunctions().generate_insert_sql(test_data))
    ...
    def test_generate_update_sql(self):
        ...
        self.assertEqual(expected, InsertUpdateStepMetadataComparisonFunctions().generate_update_sql(test_data))
    ...
    def test_generate_delete_sql(self):
        ...
        self.assertEqual(expected, InsertUpdateStepMetadataComparisonFunctions().generate_delete_sql(test_data))
