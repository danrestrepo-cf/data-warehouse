...
class TestTableOutputStepMetadataComparisonFunctions(unittest.TestCase):
    ...
    def test_construct_metadata_table_from_config_db(self):
        ...
        """
        test_data = [
            {'process_name': 'ETL-1', 'target_schema': 'history_octane', 'target_table': 'table1', 'truncate_table': 'N',
             'connectionname': 'Staging DB Connection'},
            {'process_name': 'ETL-2', 'target_schema': 'history_octane', 'target_table': 'table2', 'truncate_table': 'N',
             'connectionname': 'Staging DB Connection'},
            {'process_name': 'ETL-3', 'target_schema': 'history_octane', 'target_table': 'table3', 'truncate_table': 'N',
             'connectionname': 'Staging DB Connection'},
        ]
