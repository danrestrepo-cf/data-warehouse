--
-- EDW | Deployment Fixes - reset history_octane and star_loan table data and stop automated ETL schedules
-- https://app.asana.com/0/0/1200577408128139
--

-- Truncate/delete non-zero data from star_loan tables

TRUNCATE star_loan.loan_fact;
TRUNCATE star_loan.loan_lender_user_access;

DELETE FROM star_loan.application_dim WHERE dwid <> 0;
DELETE FROM star_loan.borrower_demographics_dim WHERE dwid <> 0;
DELETE FROM star_loan.borrower_dim WHERE dwid <> 0;
DELETE FROM star_loan.borrower_lending_profile_dim WHERE dwid <> 0;
DELETE FROM star_loan.hmda_purchaser_of_loan_dim WHERE dwid <> 0;
DELETE FROM star_loan.interim_funder_dim WHERE dwid <> 0;
DELETE FROM star_loan.investor_dim WHERE dwid <> 0;
DELETE FROM star_loan.lender_user_dim WHERE dwid <> 0;
DELETE FROM star_loan.loan_beneficiary_dim WHERE dwid <> 0;
DELETE FROM star_loan.loan_dim WHERE dwid <> 0;
DELETE FROM star_loan.loan_funding_dim WHERE dwid <> 0;
DELETE FROM star_loan.loan_junk_dim WHERE dwid <> 0;
DELETE FROM star_loan.mortgage_insurance_dim WHERE loan_dwid <> 0;
DELETE FROM star_loan.product_choice_dim WHERE dwid <> 0;
DELETE FROM star_loan.product_dim WHERE dwid <> 0;
DELETE FROM star_loan.product_terms_dim WHERE dwid <> 0;
DELETE FROM star_loan.transaction_dim WHERE dwid <> 0;
DELETE FROM star_loan.transaction_junk_dim WHERE dwid <> 0;

-- Truncate history_octane tables
...
TRUNCATE history_octane.applicant_role_type;
TRUNCATE history_octane.application;
TRUNCATE history_octane.application_taken_method_type;
...
TRUNCATE history_octane.arm_index_type;
...
TRUNCATE history_octane.aus_type;
...
TRUNCATE history_octane.borrower_relationship_type;
TRUNCATE history_octane.borrower_reo;
TRUNCATE history_octane.borrower_residence;
TRUNCATE history_octane.borrower_residency_basis_type;
TRUNCATE history_octane.borrower_tax_filing;
TRUNCATE history_octane.borrower_tiny_id_type;
...
TRUNCATE history_octane.building_status_type;
...
TRUNCATE history_octane.buydown_base_date_type;
TRUNCATE history_octane.buydown_contributor_type;
TRUNCATE history_octane.buydown_schedule_type;
TRUNCATE history_octane.buydown_subsidy_calculation_type;
...
TRUNCATE history_octane.citizenship_residency_type;
TRUNCATE history_octane.clg_flood_cert_status_type;
TRUNCATE history_octane.closing_document_status_type;
TRUNCATE history_octane.coarse_event_type;
TRUNCATE history_octane.community_lending_type;
...
TRUNCATE history_octane.cost_center;
TRUNCATE history_octane.country_type;
TRUNCATE history_octane.county;
...
TRUNCATE history_octane.courier_type;
TRUNCATE history_octane.credit_authorization_method_type;
TRUNCATE history_octane.credit_bureau_type;
...
TRUNCATE history_octane.days_per_year_type;
...
TRUNCATE history_octane.deal_lender_user;
...
TRUNCATE history_octane.decision_credit_score_calc_type;
TRUNCATE history_octane.delivery_aus_type;
...
TRUNCATE history_octane.du_key_finding;
TRUNCATE history_octane.du_key_finding_type;
TRUNCATE history_octane.du_recommendation_type;
TRUNCATE history_octane.du_refi_plus_finding;
...
TRUNCATE history_octane.fha_program_code_type;
TRUNCATE history_octane.fha_rehab_program_type;
TRUNCATE history_octane.fha_special_program_type;
...
TRUNCATE history_octane.fnm_arm_plan_type;
TRUNCATE history_octane.fnm_community_lending_product_type;
TRUNCATE history_octane.fnm_community_seconds_repayment_structure_type;
TRUNCATE history_octane.fnm_investor_remittance_type;
TRUNCATE history_octane.fnm_mbs_loan_default_loss_party_type;
TRUNCATE history_octane.fnm_mbs_reo_marketing_party_type;
TRUNCATE history_octane.for_further_credit_type;
TRUNCATE history_octane.formula_report_column;
TRUNCATE history_octane.fre_community_program_type;
TRUNCATE history_octane.fre_ctp_closing_feature_type;
TRUNCATE history_octane.fre_ctp_closing_type;
TRUNCATE history_octane.fre_doc_level_description_type;
TRUNCATE history_octane.fre_purchase_eligibility_type;
TRUNCATE history_octane.fund_source_type;
TRUNCATE history_octane.funding_status_type;
TRUNCATE history_octane.gender_type;
TRUNCATE history_octane.gift_funds_type;
TRUNCATE history_octane.google_sheet_export;
TRUNCATE history_octane.gse_version_type;
TRUNCATE history_octane.heloc_cancel_fee_applicable_type;
...
TRUNCATE history_octane.hmda_hoepa_status_type;
TRUNCATE history_octane.hmda_purchaser_of_loan_2017_type;
TRUNCATE history_octane.hmda_purchaser_of_loan_2018_type;
...
TRUNCATE history_octane.homeownership_education_type;
TRUNCATE history_octane.housing_counseling_agency_type;
TRUNCATE history_octane.housing_counseling_type;
...
TRUNCATE history_octane.interest_only_type;
TRUNCATE history_octane.interim_funder;
TRUNCATE history_octane.interim_funder_mers_registration_type;
TRUNCATE history_octane.investor;
TRUNCATE history_octane.investor_group;
TRUNCATE history_octane.investor_hmda_purchaser_of_loan_type;
...
TRUNCATE history_octane.ipc_calc_type;
TRUNCATE history_octane.ipc_comparison_operator_type;
TRUNCATE history_octane.ipc_property_usage_type;
...
TRUNCATE history_octane.legal_entity_type;
...
TRUNCATE history_octane.lender_user;
...
TRUNCATE history_octane.lender_user_status_type;
TRUNCATE history_octane.lender_user_type;
...
TRUNCATE history_octane.liability_new;
...
TRUNCATE history_octane.lien_priority_type;
TRUNCATE history_octane.loan;
TRUNCATE history_octane.loan_access_type;
TRUNCATE history_octane.loan_amortization_type;
TRUNCATE history_octane.loan_benef_transfer_status_type;
TRUNCATE history_octane.loan_beneficiary;
...
TRUNCATE history_octane.loan_closing_doc;
TRUNCATE history_octane.loan_eligible_investor;
TRUNCATE history_octane.loan_file_delivery_method_type;
TRUNCATE history_octane.loan_funding;
...
TRUNCATE history_octane.loan_purpose_type;
...
TRUNCATE history_octane.lqa_purchase_eligibility_type;
...
TRUNCATE history_octane.marital_status_type;
...
TRUNCATE history_octane.mers_transfer_status_type;
TRUNCATE history_octane.mi_calculated_rate_type;
TRUNCATE history_octane.mi_company_name_type;
TRUNCATE history_octane.mi_initial_calculation_type;
TRUNCATE history_octane.mi_input_type;
...
TRUNCATE history_octane.mi_payer_type;
TRUNCATE history_octane.mi_payment_type;
TRUNCATE history_octane.mi_premium_refundable_type;
TRUNCATE history_octane.mi_renewal_calculation_type;
...
TRUNCATE history_octane.mortgage_type;
TRUNCATE history_octane.native_american_lands_type;
TRUNCATE history_octane.negative_amortization_type;
TRUNCATE history_octane.neighborhood_location_type;
...
TRUNCATE history_octane.org_division;
TRUNCATE history_octane.org_division_leader;
TRUNCATE history_octane.org_division_terms;
TRUNCATE history_octane.org_group;
TRUNCATE history_octane.org_group_leader;
TRUNCATE history_octane.org_group_terms;
TRUNCATE history_octane.org_leader_position_type;
TRUNCATE history_octane.org_lender_user_terms;
TRUNCATE history_octane.org_lineage;
TRUNCATE history_octane.org_lineage_node;
TRUNCATE history_octane.org_lineage_tracker;
TRUNCATE history_octane.org_node;
TRUNCATE history_octane.org_node_lender_user;
TRUNCATE history_octane.org_node_lender_user_type;
TRUNCATE history_octane.org_node_tree;
TRUNCATE history_octane.org_node_type;
TRUNCATE history_octane.org_node_version;
TRUNCATE history_octane.org_region;
TRUNCATE history_octane.org_region_leader;
TRUNCATE history_octane.org_region_terms;
TRUNCATE history_octane.org_team;
TRUNCATE history_octane.org_team_leader;
TRUNCATE history_octane.org_team_terms;
TRUNCATE history_octane.org_unit;
TRUNCATE history_octane.org_unit_leader;
TRUNCATE history_octane.org_unit_terms;
...
TRUNCATE history_octane.partial_payment_policy_type;
TRUNCATE history_octane.payment_adjustment_calculation_type;
TRUNCATE history_octane.payment_frequency_type;
...
TRUNCATE history_octane.payment_structure_type;
...
TRUNCATE history_octane.place;
TRUNCATE history_octane.polling_interval_type;
TRUNCATE history_octane.preferred_settlement;
TRUNCATE history_octane.prepaid_interest_rate_type;
TRUNCATE history_octane.prepay_penalty_schedule_type;
TRUNCATE history_octane.prepay_penalty_type;
TRUNCATE history_octane.price_processing_time;
TRUNCATE history_octane.pricing_engine_type;
TRUNCATE history_octane.prior_property_title_type;
TRUNCATE history_octane.prior_to_type;
TRUNCATE history_octane.product;
TRUNCATE history_octane.product_add_on;
TRUNCATE history_octane.product_add_on_rule;
TRUNCATE history_octane.product_appraisal_requirement_type;
...
TRUNCATE history_octane.product_side_type;
TRUNCATE history_octane.product_special_program_type;
TRUNCATE history_octane.product_terms;
...
TRUNCATE history_octane.property_category_type;
...
TRUNCATE history_octane.property_rights_type;
TRUNCATE history_octane.property_usage_type;
...
TRUNCATE history_octane.proposal_structure_type;
...
TRUNCATE history_octane.qualified_mortgage_status_type;
TRUNCATE history_octane.qualified_mortgage_thresholds;
TRUNCATE history_octane.qualifying_monthly_payment_type;
TRUNCATE history_octane.qualifying_rate_type;
...
TRUNCATE history_octane.section_of_act_coarse_type;
...
TRUNCATE history_octane.servicing_transfer_type;
...
TRUNCATE history_octane.smart_doc_note;
TRUNCATE history_octane.smart_doc_note_comment;
TRUNCATE history_octane.smart_doc_note_monitor;
...
TRUNCATE history_octane.smart_ledger_plan_case_type;
...
TRUNCATE history_octane.state_type;
...
TRUNCATE history_octane.third_party_community_second_program_eligibility_type;
TRUNCATE history_octane.time_zone_type;
...
TRUNCATE history_octane.wf_wait_until_time_slice;
TRUNCATE history_octane.yes_no_na_type;
TRUNCATE history_octane.yes_no_na_unknown_type;
TRUNCATE history_octane.yes_no_unknown_type;
