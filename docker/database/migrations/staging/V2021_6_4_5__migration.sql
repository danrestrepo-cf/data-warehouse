--
-- EDW | star_loan - migrate star_loan.loan_lender_user_access partitions to star_loan schema
-- https://app.asana.com/0/0/1200517388794627
--
...
--re-create loan_lender_user_access table and its partitions in the star_loan schema
