...
CREATE INDEX idx_loan_pid ON star_loan.loan_fact (loan_pid);
CREATE INDEX idx_loan_junk_dwid ON star_loan.loan_fact (loan_junk_dwid);
CREATE INDEX idx_product_choices_dwid ON star_loan.loan_fact (product_choices_dwid);
CREATE INDEX idx_transaction_dwid ON star_loan.loan_fact (transaction_dwid);
CREATE INDEX idx_transaction_junk_dwid ON star_loan.loan_fact (transaction_junk_dwid);
CREATE INDEX idx_loan_beneficiary_dwid ON star_loan.loan_fact (loan_beneficiary_dwid);
CREATE INDEX idx_loan_funding_dwid ON star_loan.loan_fact (loan_funding_dwid);
CREATE INDEX idx_b1_borrower_dwid ON star_loan.loan_fact (b1_borrower_dwid);
CREATE INDEX idx_b2_borrower_dwid ON star_loan.loan_fact (b2_borrower_dwid);
CREATE INDEX idx_b3_borrower_dwid ON star_loan.loan_fact (b3_borrower_dwid);
CREATE INDEX idx_b4_borrower_dwid ON star_loan.loan_fact (b4_borrower_dwid);
CREATE INDEX idx_b5_borrower_dwid ON star_loan.loan_fact (b5_borrower_dwid);
CREATE INDEX idx_c1_borrower_dwid ON star_loan.loan_fact (c1_borrower_dwid);
CREATE INDEX idx_c2_borrower_dwid ON star_loan.loan_fact (c2_borrower_dwid);
CREATE INDEX idx_c3_borrower_dwid ON star_loan.loan_fact (c3_borrower_dwid);
CREATE INDEX idx_c4_borrower_dwid ON star_loan.loan_fact (c4_borrower_dwid);
CREATE INDEX idx_c5_borrower_dwid ON star_loan.loan_fact (c5_borrower_dwid);
CREATE INDEX idx_n1_borrower_dwid ON star_loan.loan_fact (n1_borrower_dwid);
CREATE INDEX idx_n2_borrower_dwid ON star_loan.loan_fact (n2_borrower_dwid);
CREATE INDEX idx_n3_borrower_dwid ON star_loan.loan_fact (n3_borrower_dwid);
CREATE INDEX idx_n4_borrower_dwid ON star_loan.loan_fact (n4_borrower_dwid);
CREATE INDEX idx_n5_borrower_dwid ON star_loan.loan_fact (n5_borrower_dwid);
CREATE INDEX idx_n6_borrower_dwid ON star_loan.loan_fact (n6_borrower_dwid);
CREATE INDEX idx_n7_borrower_dwid ON star_loan.loan_fact (n7_borrower_dwid);
CREATE INDEX idx_n8_borrower_dwid ON star_loan.loan_fact (n8_borrower_dwid);
CREATE INDEX idx_b1_borrower_demographics_dwid ON star_loan.loan_fact (b1_borrower_demographics_dwid);
CREATE INDEX idx_b1_borrower_lending_profile_dwid ON star_loan.loan_fact (b1_borrower_lending_profile_dwid);
CREATE INDEX idx_application_dwid ON star_loan.loan_fact (application_dwid);
CREATE INDEX idx_collateral_to_custodian_lender_user_dwid ON star_loan.loan_fact (collateral_to_custodian_lender_user_dwid);
CREATE INDEX idx_interim_funder_dwid ON star_loan.loan_fact (interim_funder_dwid);
CREATE INDEX idx_product_terms_dwid ON star_loan.loan_fact (product_terms_dwid);
CREATE INDEX idx_product_dwid ON star_loan.loan_fact (product_dwid);
CREATE INDEX idx_investor_dwid ON star_loan.loan_fact (investor_dwid);
CREATE INDEX idx_hmda_purchaser_of_loan_dwid ON star_loan.loan_fact (hmda_purchaser_of_loan_dwid);
CREATE INDEX idx_agency_case_id_assigned_date_dwid ON star_loan.loan_fact (agency_case_id_assigned_date_dwid);
CREATE INDEX idx_apor_date_dwid ON star_loan.loan_fact (apor_date_dwid);
CREATE INDEX idx_application_signed_date_dwid ON star_loan.loan_fact (application_signed_date_dwid);
CREATE INDEX idx_approved_with_conditions_date_dwid ON star_loan.loan_fact (approved_with_conditions_date_dwid);
CREATE INDEX idx_beneficiary_from_date_dwid ON star_loan.loan_fact (beneficiary_from_date_dwid);
CREATE INDEX idx_beneficiary_through_date_dwid ON star_loan.loan_fact (beneficiary_through_date_dwid);
CREATE INDEX idx_collateral_sent_date_dwid ON star_loan.loan_fact (collateral_sent_date_dwid);
CREATE INDEX idx_disbursement_date_dwid ON star_loan.loan_fact (disbursement_date_dwid);
CREATE INDEX idx_early_funding_date_dwid ON star_loan.loan_fact (early_funding_date_dwid);
CREATE INDEX idx_effective_funding_date_dwid ON star_loan.loan_fact (effective_funding_date_dwid);
CREATE INDEX idx_fha_endorsement_date_dwid ON star_loan.loan_fact (fha_endorsement_date_dwid);
CREATE INDEX idx_estimated_funding_date_dwid ON star_loan.loan_fact (estimated_funding_date_dwid);
CREATE INDEX idx_intent_to_proceed_date_dwid ON star_loan.loan_fact (intent_to_proceed_date_dwid);
CREATE INDEX idx_funding_date_dwid ON star_loan.loan_fact (funding_date_dwid);
CREATE INDEX idx_funding_requested_date_dwid ON star_loan.loan_fact (funding_requested_date_dwid);
CREATE INDEX idx_loan_file_ship_date_dwid ON star_loan.loan_fact (loan_file_ship_date_dwid);
CREATE INDEX idx_mers_transfer_creation_date_dwid ON star_loan.loan_fact (mers_transfer_creation_date_dwid);
CREATE INDEX idx_pending_wire_date_dwid ON star_loan.loan_fact (pending_wire_date_dwid);
CREATE INDEX idx_rejected_date_dwid ON star_loan.loan_fact (rejected_date_dwid);
CREATE INDEX idx_return_confirmed_date_dwid ON star_loan.loan_fact (return_confirmed_date_dwid);
CREATE INDEX idx_return_request_date_dwid ON star_loan.loan_fact (return_request_date_dwid);
CREATE INDEX idx_scheduled_release_date_dwid ON star_loan.loan_fact (scheduled_release_date_dwid);
CREATE INDEX idx_usda_guarantee_date_dwid ON star_loan.loan_fact (usda_guarantee_date_dwid);
CREATE INDEX idx_va_guaranty_date_dwid ON star_loan.loan_fact (va_guaranty_date_dwid);
CREATE INDEX idx_loan_pid ON star_loan.loan_dim (loan_pid);
CREATE INDEX idx_proposal_pid ON star_loan.loan_dim (proposal_pid);
CREATE INDEX idx_product_terms_pid ON star_loan.loan_dim (product_terms_pid);
CREATE INDEX idx_los_loan_number ON star_loan.loan_dim (los_loan_number);
CREATE INDEX idx_lien_priority ON star_loan.loan_junk_dim (lien_priority);
CREATE INDEX idx_mortgage_type ON star_loan.product_choice_dim (mortgage_type);
CREATE INDEX idx_structure ON star_loan.transaction_junk_dim (structure);
CREATE INDEX idx_borrower_pid ON star_loan.borrower_dim (borrower_pid);
CREATE INDEX idx_application_pid ON star_loan.borrower_dim (application_pid);
CREATE INDEX idx_applicant_role ON star_loan.borrower_dim (applicant_role);
CREATE INDEX idx_decision_credit_score ON star_loan.borrower_dim (decision_credit_score);
CREATE INDEX idx_tiny_id ON star_loan.borrower_dim (tiny_id);
CREATE INDEX idx_lender_employee ON star_loan.borrower_lending_profile_dim (lender_employee);
CREATE INDEX idx_interim_funder_pid ON star_loan.interim_funder_dim (interim_funder_pid);
CREATE INDEX idx_name ON star_loan.interim_funder_dim (name);
CREATE INDEX idx_investor_pid ON star_loan.investor_dim (investor_pid);
CREATE INDEX idx_beneficiary_name ON star_loan.investor_dim (beneficiary_name);
CREATE INDEX idx_investor_name ON star_loan.investor_dim (investor_name);
CREATE INDEX idx_nmls_id ON star_loan.investor_dim (nmls_id);
CREATE INDEX idx_servicer_name ON star_loan.investor_dim (servicer_name);
CREATE INDEX idx_lender_user_pid ON star_loan.lender_user_dim (lender_user_pid);
CREATE INDEX idx_nmls_loan_originator_id ON star_loan.lender_user_dim (nmls_loan_originator_id);
CREATE INDEX idx_status ON star_loan.lender_user_dim (status);
CREATE INDEX idx_type ON star_loan.lender_user_dim (type);
CREATE INDEX idx_unparsed_name ON star_loan.lender_user_dim (unparsed_name);
CREATE INDEX idx_start_date ON star_loan.lender_user_dim (start_date);
CREATE INDEX idx_through_date ON star_loan.lender_user_dim (through_date);
CREATE INDEX idx_loan_beneficiary_pid ON star_loan.loan_beneficiary_dim (loan_beneficiary_pid);
CREATE INDEX idx_loan_pid ON star_loan.loan_beneficiary_dim (loan_pid);
CREATE INDEX idx_transfer_status ON star_loan.loan_beneficiary_dim (transfer_status);
CREATE INDEX idx_loan_funding_pid ON star_loan.loan_funding_dim (loan_funding_pid);
CREATE INDEX idx_loan_pid ON star_loan.loan_funding_dim (loan_pid);
CREATE INDEX idx_interim_funder_pid ON star_loan.loan_funding_dim (interim_funder_pid);
CREATE INDEX idx_funding_status ON star_loan.loan_funding_dim (funding_status);
CREATE INDEX idx_loan_pid ON star_loan.mortgage_insurance_dim (loan_pid);
CREATE INDEX idx_product_pid ON star_loan.product_dim (product_pid);
CREATE INDEX idx_investor_pid ON star_loan.product_dim (investor_pid);
CREATE INDEX idx_fund_source ON star_loan.product_dim (fund_source);
CREATE INDEX idx_product_side ON star_loan.product_dim (product_side);
CREATE INDEX idx_product_terms_pid ON star_loan.product_terms_dim (product_terms_pid);
CREATE INDEX idx_product_pid ON star_loan.product_terms_dim (product_pid);
CREATE INDEX idx_high_balance ON star_loan.product_terms_dim (high_balance);
CREATE INDEX idx_lien_priority ON star_loan.product_terms_dim (lien_priority);
CREATE INDEX idx_loan_amortization ON star_loan.product_terms_dim (loan_amortization);
CREATE INDEX idx_mortgage_type ON star_loan.product_terms_dim (mortgage_type);
CREATE INDEX idx_product_special_program ON star_loan.product_terms_dim (product_special_program);
CREATE INDEX idx_application_pid ON star_loan.application_dim (application_pid);
CREATE INDEX idx_proposal_pid ON star_loan.application_dim (proposal_pid);
CREATE INDEX idx_deal_pid ON star_loan.transaction_dim (deal_pid);
CREATE INDEX idx_active_proposal_pid ON star_loan.transaction_dim (active_proposal_pid);