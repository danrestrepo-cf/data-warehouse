...
INSERT INTO mdi.table_output_step (dwid, process_dwid, target_schema, target_table, commit_size, partitioning_field,
                                   ...
                                   use_batch_update)
VALUES
(5, 5, 'mcr', 'nmls_call_report_national', 1000, null, null, null, null, 'N', null, 'Y', 'Staging DB Connection', 'N',
 'Y', 'N', 'N')
;
...
, (30, 5, 'state_type', 'state_type', 3)
, (31, 5, 'unpaid_balance', 'unpaid_balance', 4)
, (32, 5, 'loan_count', 'loan_count', 5)
, (33, 5, 'avg_loan_size', 'avg_loan_size', 6)
, (34, 5, 'etl_batch_id', 'etl_batch_id', 7)
, (35, 5, 'data_source_dwid', 'data_source_dwid', 8)
;
...
(4, 4, 'mcr', 'nmls_call_report_national', 1000, null, null, null, null, 'N', null, 'Y', 'Staging DB Connection',
  'N', 'Y', 'N', 'N');                                                                                                                                                                                                                                                                                                                                                                          (4, 4, 'mcr', 'nmls_call_report_national', 1000, null, null, null, null, 'N', null, 'Y', 'Staging DB Connection', 'N', 'Y', 'N', 'N');
...
INSERT INTO mdi.table_output_step (dwid, process_dwid, target_schema, target_table, commit_size, partitioning_field,
                                   ...
                                   use_batch_update)
VALUES
(6, 6, 'mcr', 'nmls_call_report_national', 1000, null, null, null, null, 'N', null, 'Y', 'Staging DB Connection', 'N',
 'Y', 'N', 'N');                                                                                                                                                                                                                                                                                                                                                                          (4, 4, 'mcr', 'nmls_call_report_national', 1000, null, null, null, null, 'N', null, 'Y', 'Staging DB Connection', 'N', 'Y', 'N', 'N');

INSERT INTO mdi.table_output_field
(dwid, table_output_step_dwid, database_field_name, database_stream_name, field_order)
VALUES
(36, 6, 'state_type', 'state_type', 1)
     , (37, 6, 'mcr_desc', 'mcr_desc', 2)
     , (38, 6, 'item_id', 'item_id', 3)
     , (39, 6, 'servicer_id', 'servicer_id', 4)
     , (40, 6, 'servicer_name', 'servicer_name', 5)
     , (41, 6, 'pool_number', 'pool_number', 6)
     , (42, 6, 'data_source_dwid', 'data_source_dwid', 7)
     , (43, 6, 'servicer_name', 'servicer_name', 8)
     , (44, 6, 'pool_number', 'pool_number', 9)
     , (45, 6, 'data_source_dwid', 'data_source_dwid', 10)
;
