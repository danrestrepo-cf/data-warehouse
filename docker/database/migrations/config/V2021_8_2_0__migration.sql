...
WITH cte_process as (INSERT INTO mdi.process (name, description)    -- mdi.process
   ...
   , cte_csv_file_input_field_list (field_name, field_type, field_format, field_length, field_precision, field_trim_type, field_order) AS (
    VALUES  ('loan_number', 'String', NULL, -1, -1, 'none', 1)
         ...
         , ('first_due_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 5)
         , ('loan_closing_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 6)
         , ('loan_purpose_code', 'String', NULL, -1, -1, 'none', 7)
         , ('loan_purpose_code_description', 'String', NULL, -1, -1, 'none', 8)
         , ('note_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 9)
         , ('acquisition_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 10)
         , ('original_interest_rate', 'Number', '#.#', -1, -1, 'none', 11)
         , ('original_loan_term', 'Integer', '#', -1, -1, 'none', 12)
         , ('original_mortgage_amount', 'Number', '#.#', -1, -1, 'none', 13)
         , ('original_p_and_i_amount', 'Number', '#.#', -1, -1, 'none', 14)
         , ('original_property_value_amount', 'Number', '#.#', -1, -1, 'none', 15)
         , ('original_second_interest_rate', 'Number', '#.#', -1, -1, 'none', 16)
         , ('original_second_loan_term', 'Integer', '#', -1, -1, 'none', 17)
         , ('original_second_mtg_amount', 'Number', '#.#', -1, -1, 'none', 18)
         , ('original_second_p_and_i', 'Number', '#.#', -1, -1, 'none', 19)
         , ('original_loan_to_value_ratio', 'Number', '#.#', -1, -1, 'none', 20)
         , ('annual_interest_rate', 'Number', '#.#', -1, -1, 'none', 21)
         , ('arm_indicator', 'String', NULL, -1, -1, 'none', 22)
         , ('drafting_indicator', 'String', NULL, -1, -1, 'none', 23)
         , ('draft_option_code', 'String', NULL, -1, -1, 'none', 24)
         , ('draft_delay_days_quantity', 'Integer', '#', -1, -1, 'none', 25)
         , ('billing_mode', 'String', NULL, -1, -1, 'none', 26)
         , ('coupon_tape_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 27)
         , ('coupon_bill_last_create_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 28)
         , ('def_int_balance', 'Number', '#.#', -1, -1, 'none', 29)
         , ('distribution_type', 'String', NULL, -1, -1, 'none', 30)
         , ('loan_to_value_ratio', 'Number', '#.#', -1, -1, 'none', 31)
         , ('first_p_and_i_amount', 'Number', '#.#', -1, -1, 'none', 32)
         , ('first_principal_balance', 'Number', '#.#', -1, -1, 'none', 33)
         , ('el_status_indicator', 'String', NULL, -1, -1, 'none', 34)
         , ('interest_only_expire_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 35)
         ...
         , ('loan_matures_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 66)
         , ('loan_term', 'Integer', '#', -1, -1, 'none', 67)
         , ('remaining_term', 'Integer', '#', -1, -1, 'none', 68)
         ...
         , ('mers_registration_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 75)
         , ('mers_id_number_status_code', 'String', NULL, -1, -1, 'none', 76)
         , ('mers_assigned_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 77)
         , ('next_payment_due_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 78)
         , ('last_full_payment_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 79)
         , ('due_date_day_portion_parsed', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 80)
         , ('payment_period', 'Integer', '#', -1, -1, 'none', 81)
         , ('payment_option_code', 'String', NULL, -1, -1, 'none', 82)
         , ('payment_option_code_description', 'String', NULL, -1, -1, 'none', 83)
         , ('suspense_balance', 'Number', '#.#', -1, -1, 'none', 84)
         , ('nsf_fee_balance', 'Number', '#.#', -1, -1, 'none', 85)
         , ('total_monthly_payment', 'Number', '#.#', -1, -1, 'none', 86)
         ...
         , ('appraisal_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 114)
         , ('property_value_amount', 'Integer', '#', -1, -1, 'none', 115)
         ...
         , ('flood_community_start_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 123)
         , ('flood_program_type', 'String', NULL, -1, -1, 'none', 124)
         , ('flood_loma_revision_code', 'String', NULL, -1, -1, 'none', 125)
         , ('flood_loma_determination_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 126)
         ...
         , ('flood_firm_effective_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 134)
         , ('flood_mapping_company_id', 'String', NULL, -1, -1, 'none', 135)
         , ('flood_certification_number', 'String', NULL, -1, -1, 'none', 136)
         , ('grace_days', 'Integer', '#', -1, -1, 'none', 137)
         , ('late_charge_amount', 'Number', '#.#', -1, -1, 'none', 138)
         , ('late_charge_code', 'String', NULL, -1, -1, 'none', 139)
         , ('late_charge_code_description', 'String', NULL, -1, -1, 'none', 140)
         , ('late_charge_factor', 'Number', '#.#', -1, -1, 'none', 141)
         , ('maximum_late_charge_amount', 'Number', '#.#', -1, -1, 'none', 142)
         , ('minimum_late_charge_amount', 'Number', '#.#', -1, -1, 'none', 143)
         ...
         , ('escrow_advance_balance', 'Integer', '#', -1, -1, 'none', 148)
         , ('escrow_balance', 'Number', '#.#', -1, -1, 'none', 149)
         , ('escrow_replace_resrv_balance', 'Number', '#.#', -1, -1, 'none', 150)
         , ('hazard_ins_monthly_amount', 'Number', '#.#', -1, -1, 'none', 151)
         , ('replace_reserve_amount', 'Number', '#.#', -1, -1, 'none', 152)
         , ('restricted_escrow_balance', 'Number', '#.#', -1, -1, 'none', 153)
         , ('t_and_i_monthly_amount', 'Number', '#.#', -1, -1, 'none', 154)
         , ('a_and_h_premium_amount', 'Number', '#.#', -1, -1, 'none', 155)
         , ('life_premium_amount', 'Number', '#.#', -1, -1, 'none', 156)
         , ('interest_paid_through_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 157)
         , ('ln_mod_code', 'String', NULL, -1, -1, 'none', 158)
         , ('ln_mod_code_description', 'String', NULL, -1, -1, 'none', 159)
         , ('last_analysis_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 160)
         , ('last_analysis_effective_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 161)
         , ('last_analysis_os_spread_months', 'Integer', '#', -1, -1, 'none', 162)
         , ('mi_monthly_amount', 'Number', '#.#', -1, -1, 'none', 163)
         , ('mi_term', 'Integer', '#', -1, -1, 'none', 164)
         , ('mi_disbursement_amount', 'Number', '#.#', -1, -1, 'none', 165)
         , ('mi_disbursement_due_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 166)
         , ('mi_mid_point_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 167)
         , ('mi_termination_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 168)
         , ('mi_cancellation_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 169)
         , ('mi_request_to_cancel_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 170)
         ...
         , ('recover_corp_advance_balance', 'Number', '#.#', -1, -1, 'none', 175)
         , ('third_party_recoverable_ca_bal', 'Number', '#.#', -1, -1, 'none', 176)
         , ('non_rec_corp_advance_balance', 'Number', '#.#', -1, -1, 'none', 177)
         , ('second_principal_balance', 'Number', '#.#', -1, -1, 'none', 178)
         , ('actual_deferred_balance', 'Number', '#.#', -1, -1, 'none', 179)
         , ('ytd_principal_paid_amount', 'Number', '#.#', -1, -1, 'none', 180)
         , ('ytd_interest_amount', 'Number', '#.#', -1, -1, 'none', 181)
         , ('ytd_tax_amount', 'Number', '#.#', -1, -1, 'none', 182)
         , ('ytd_ioe_amount', 'Number', '#.#', -1, -1, 'none', 183)
         , ('ytd_hazard_amt', 'Number', '#.#', -1, -1, 'none', 184)
         , ('ytd_lien_amount', 'Number', '#.#', -1, -1, 'none', 185)
         , ('ytd_mip_amount', 'Number', '#.#', -1, -1, 'none', 186)
         , ('ytd_nsf_total', 'Number', '#.#', -1, -1, 'none', 187)
         , ('ytd_restricted_ioe_amount', 'Number', '#.#', -1, -1, 'none', 188)
         , ('ytd_late_charge_amount', 'Number', '#.#', -1, -1, 'none', 189)
         ...
         , ('purchase_price', 'Number', '#.#', -1, -1, 'none', 194)
         ...
         , ('opt_ins_disbursement_amount', 'Number', '#.#', -1, -1, 'none', 206)
         , ('opt_ins_disbursement_due_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 207)
         , ('imminent_default_fico_score', 'Integer', '#', -1, -1, 'none', 208)
         , ('imminent_default_fico_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 209)
         , ('points_paid_by_borrower', 'Number', '#.#', -1, -1, 'none', 210)
         ...
         , ('sec_mortgagor_birth_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 215)
         , ('sec_co_mortgagor_birth_date', 'Date', 'mm/dd/yyyy', -1, -1, 'none', 216)
