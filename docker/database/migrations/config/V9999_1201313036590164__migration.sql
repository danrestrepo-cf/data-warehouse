--
-- EDW | star_loan.loan_fact - refactor to use batch_id start/end times instead of comparing every field to determine which records to update
-- https://app.asana.com/0/0/1201313036590164
--

UPDATE mdi.table_input_step
SET sql = 'WITH loan_fact_incl_new_records AS (
    SELECT COALESCE( loan_fact.edw_created_datetime, NOW( ) ) AS edw_created_datetime
        ...
        most_recent_purchasing_beneficiary_investor_dwid
         , GREATEST(
        deal.etl_end_date_time, proposal.etl_end_date_time, primary_application.etl_end_date_time, loan.etl_end_date_time,
        deal_key_roles.etl_end_date_time, borrower_b1.etl_end_date_time, borrower_b2.etl_end_date_time, borrower_b3.etl_end_date_time,
        borrower_b4.etl_end_date_time, borrower_b5.etl_end_date_time, borrower_c1.etl_end_date_time, borrower_c2.etl_end_date_time,
        borrower_c3.etl_end_date_time, borrower_c4.etl_end_date_time, borrower_c5.etl_end_date_time, borrower_n1.etl_end_date_time,
        borrower_n2.etl_end_date_time, borrower_n3.etl_end_date_time, borrower_n4.etl_end_date_time, borrower_n5.etl_end_date_time,
        borrower_n6.etl_end_date_time, borrower_n7.etl_end_date_time, borrower_n8.etl_end_date_time,
        current_loan_beneficiary.etl_end_date_time, initial_loan_beneficiary.etl_end_date_time,
        first_loan_beneficiary_after_initial.etl_end_date_time, most_recent_purchasing_beneficiary.etl_end_date_time,
        active_loan_funding.etl_end_date_time, interim_funder.etl_end_date_time, product_terms.etl_end_date_time, product.etl_end_date_time,
        product_investor.etl_end_date_time, application_dim.etl_end_date_time, loan_junk_dim.etl_end_date_time,
        product_choice_dim.etl_end_date_time, transaction_junk_dim.etl_end_date_time, borrower_b1_dim.etl_end_date_time,
        borrower_b2_dim.etl_end_date_time, borrower_b3_dim.etl_end_date_time, borrower_b4_dim.etl_end_date_time,
        borrower_b5_dim.etl_end_date_time, borrower_c1_dim.etl_end_date_time, borrower_c2_dim.etl_end_date_time,
        borrower_c3_dim.etl_end_date_time, borrower_c4_dim.etl_end_date_time, borrower_c5_dim.etl_end_date_time,
        borrower_n1_dim.etl_end_date_time, borrower_n2_dim.etl_end_date_time, borrower_n3_dim.etl_end_date_time,
        borrower_n4_dim.etl_end_date_time, borrower_n5_dim.etl_end_date_time, borrower_n6_dim.etl_end_date_time,
        borrower_n7_dim.etl_end_date_time, borrower_n8_dim.etl_end_date_time, borrower_demographics_dim.etl_end_date_time,
        borrower_lending_profile_dim.etl_end_date_time, hmda_purchaser_of_loan_dim.etl_end_date_time, interim_funder_dim.etl_end_date_time,
        investor_dim.etl_end_date_time, collateral_to_custodian.etl_end_date_time, account_executive.etl_end_date_time,
        closing_doc_specialist.etl_end_date_time, closing_scheduler.etl_end_date_time, collateral_to_investor.etl_end_date_time,
        collateral_underwriter.etl_end_date_time, correspondent_client_advocate.etl_end_date_time,
        final_documents_to_investor.etl_end_date_time, flood_insurance_specialist.etl_end_date_time, funder.etl_end_date_time,
        government_insurance.etl_end_date_time, ho6_specialist.etl_end_date_time, hoa_specialist.etl_end_date_time,
        hoi_specialist.etl_end_date_time, hud_va_lender_officer.etl_end_date_time, internal_construction_manager.etl_end_date_time,
        investor_conditions.etl_end_date_time, investor_stack_to_investor.etl_end_date_time, loan_officer_assistant.etl_end_date_time,
        loan_payoff_specialist.etl_end_date_time, originator.etl_end_date_time, processor.etl_end_date_time,
        project_underwriter.etl_end_date_time, subordination_specialist.etl_end_date_time, supplemental_originator.etl_end_date_time,
        title_specialist.etl_end_date_time, transaction_assistant.etl_end_date_time, underwriter.etl_end_date_time,
        underwriting_manager.etl_end_date_time, va_specialist.etl_end_date_time, verbal_voe_specialist.etl_end_date_time,
        voe_specialist.etl_end_date_time, wholesale_client_advocate.etl_end_date_time, wire_specialist.etl_end_date_time,
        current_loan_beneficiary_dim.etl_end_date_time, current_beneficiary_investor_dim.etl_end_date_time,
        initial_beneficiary_investor_dim.etl_end_date_time, first_beneficiary_after_initial_investor_dim.etl_end_date_time,
        most_recent_purchasing_beneficiary_investor_dim.etl_end_date_time, loan_dim.etl_end_date_time, loan_funding_dim.etl_end_date_time,
        product_dim.etl_end_date_time, product_terms_dim.etl_end_date_time, transaction_dim.etl_end_date_time
        ) AS max_source_etl_end_date_time
    FROM
        -- history_octane deal
        (
            SELECT deal.*
        ...
        JOIN (
            ...
            JOIN star_common.etl_log
                 ON deal_key_roles.etl_batch_id = etl_log.etl_batch_id
                 ...
                 ON borrower_lending_profile_dim.etl_batch_id = etl_log.etl_batch_id
                  ...
                  ON borrower_b1.b_alimony_child_support IS NOT DISTINCT FROM
                     ...
                     borrower_b1.b_citizenship_residency_type IS NOT DISTINCT FROM borrower_lending_profile_dim.citizenship_residency_code
                      ...
                      AND borrower_b1.b_homeownership_education_agency_type IS NOT DISTINCT FROM
                          borrower_lending_profile_dim.homeownership_education_agency_code
        ...
        LEFT JOIN star_common.date_dim agency_case_id_assigned_date_dim
                  ON loan.l_agency_case_id_assigned_date = agency_case_id_assigned_date_dim.value
        ...
        LEFT JOIN star_common.date_dim application_signed_date_dim
                  ON borrower_b1.b_application_signed_date = application_signed_date_dim.value
        LEFT JOIN star_common.date_dim approved_with_conditions_date_dim
                  ON current_loan_beneficiary.lb_approved_with_conditions_date = approved_with_conditions_date_dim.value
        LEFT JOIN star_common.date_dim beneficiary_from_date_dim
                  ON current_loan_beneficiary.lb_from_date = beneficiary_from_date_dim.value
        LEFT JOIN star_common.date_dim beneficiary_through_date_dim
                  ON current_loan_beneficiary.lb_through_date = beneficiary_through_date_dim.value
        LEFT JOIN star_common.date_dim collateral_sent_date_dim
                  ON active_loan_funding.lf_collateral_sent_date = collateral_sent_date_dim.value
        LEFT JOIN star_common.date_dim disbursement_date_dim
                  ON active_loan_funding.lf_disbursement_date = disbursement_date_dim.value
        LEFT JOIN star_common.date_dim early_funding_date_dim
                  ON current_loan_beneficiary.lb_early_funding_date = early_funding_date_dim.value
        LEFT JOIN star_common.date_dim effective_funding_date_dim
                  ON proposal.prp_effective_funding_date = effective_funding_date_dim.value
        LEFT JOIN star_common.date_dim fha_endorsement_date_dim
                  ON loan.l_fha_endorsement_date = fha_endorsement_date_dim.value
        LEFT JOIN star_common.date_dim estimated_funding_date_dim
                  ON proposal.prp_estimated_funding_date = estimated_funding_date_dim.value
        LEFT JOIN star_common.date_dim intent_to_proceed_date_dim
                  ON proposal.prp_intent_to_proceed_date = intent_to_proceed_date_dim.value
        ...
        LEFT JOIN star_common.date_dim funding_requested_date_dim
                  ON active_loan_funding.lf_requested_date = funding_requested_date_dim.value
        LEFT JOIN star_common.date_dim loan_file_ship_date_dim
                  ON current_loan_beneficiary.lb_loan_file_ship_date = loan_file_ship_date_dim.value
        LEFT JOIN star_common.date_dim mers_transfer_creation_date_dim
                  ON current_loan_beneficiary.lb_mers_transfer_creation_date = mers_transfer_creation_date_dim.value
        LEFT JOIN star_common.date_dim pending_wire_date_dim
                  ON current_loan_beneficiary.lb_pending_wire_date = pending_wire_date_dim.value
        LEFT JOIN star_common.date_dim rejected_date_dim
                  ON current_loan_beneficiary.lb_rejected_date = rejected_date_dim.value
        LEFT JOIN star_common.date_dim return_confirmed_date_dim
                  ON active_loan_funding.lf_return_confirmed_date = return_confirmed_date_dim.value
        LEFT JOIN star_common.date_dim return_request_date_dim
                  ON active_loan_funding.lf_return_request_date = return_request_date_dim.value
        LEFT JOIN star_common.date_dim scheduled_release_date_dim
                  ON active_loan_funding.lf_scheduled_release_date = scheduled_release_date_dim.value
...
SELECT loan_fact_incl_new_records.*
FROM loan_fact_incl_new_records
LEFT JOIN star_loan.loan_fact
          ON loan_fact_incl_new_records.data_source_integration_id = loan_fact.data_source_integration_id
...
FROM loan_fact_incl_new_records
JOIN (
    SELECT loan_fact.data_source_integration_id, etl_log.etl_start_date_time
    FROM star_loan.loan_fact
    JOIN star_common.etl_log
         ON loan_fact.etl_batch_id = etl_log.etl_batch_id
) AS loan_fact_etl_start_times
     ON loan_fact_incl_new_records.data_source_integration_id = loan_fact_etl_start_times.data_source_integration_id
         AND loan_fact_incl_new_records.max_source_etl_end_date_time >= loan_fact_etl_start_times.etl_start_date_time;'
FROM mdi.process
WHERE process.dwid = table_input_step.process_dwid
  AND process.name = 'SP-300001-insert-update';
