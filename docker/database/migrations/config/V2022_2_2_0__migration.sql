...
WITH insert_rows (database_name, schema_name, table_name, field_name, data_type, source_database_name, source_schema_name, source_table_name, source_field_name) AS (
    VALUES ('staging', 'star_loan', 'loan_fact', 'current_transaction_stage_from_date_dwid', 'BIGINT', NULL, NULL, NULL, NULL)
         , ('staging', 'star_loan', 'transaction_dim', 'current_transaction_stage', 'VARCHAR(1024)', NULL, NULL, NULL, NULL)
         , ('staging', 'star_loan', 'transaction_dim', 'current_transaction_stage_code', 'VARCHAR(128)', NULL, NULL, NULL, NULL)
)
INSERT
...
WITH insert_rows (process_name, update_lookup, update_flag) AS (
    VALUES ('SP-300001-insert-update', 'current_transaction_stage_from_date_dwid', 'Y')
         , ('SP-200019', 'current_transaction_stage', 'Y')
         , ('SP-200019', 'current_transaction_stage_code', 'Y')
)
INSERT
...
WITH update_rows (process_name, data_source_dwid, sql, connectionname) AS (
    VALUES ('SP-300001-insert-update', 1, 'SELECT loan_fact_incl_new_records.edw_created_datetime
...
--table_input_step
WITH update_rows (process_name, data_source_dwid, sql, connectionname) AS (
    VALUES ('SP-200004', 1, 'WITH borrower_demographics_dim_new_records AS (
     ...
     ON borrower_demographics_dim_new_records.data_source_integration_id =
        borrower_demographics_dim_etl_start_times.data_source_integration_id
         AND borrower_demographics_dim_new_records.max_source_etl_end_date_time >=
             borrower_demographics_dim_etl_start_times.etl_start_date_time;', 'Staging DB Connection')
         , ('SP-200006', 1, 'WITH borrower_lending_profile_dim_new_records AS (
    SELECT ''sex_refused_code~sex_collected_visual_or_surname_code~sex_male_flag~sex_female_flag~sex_not_obtainable_flag~ethnicity_refused_code~ethnicity_collected_visual_or_surname_code~ethnicity_hispanic_or_latino_flag~ethnicity_mexican_flag~ethnicity_puerto_rican_flag~ethnicity_cuban_flag~ethnicity_other_hispanic_or_latino_flag~ethnicity_not_hispanic_or_latino_flag~ethnicity_not_obtainable_flag~marital_status_code~race_refused_code~race_collected_visual_or_surname_code~race_american_indian_or_alaska_native_flag~race_asian_flag~race_asian_indian_flag~race_chinese_flag~race_filipino_flag~race_japanese_flag~race_korean_flag~race_vietnamese_flag~race_other_asian_flag~race_black_or_african_american_flag~race_information_not_provided_flag~race_national_origin_refusal_flag~race_native_hawaiian_or_other_pacific_islander_flag~race_native_hawaiian_flag~race_guamanian_or_chamorro_flag~race_samoan_flag~race_other_pacific_islander_flag~race_not_obtainable_flag~race_not_applicable_flag~race_white_flag~schooling_years~race_other_pacific_islander_description_flag~data_source_dwid~ethnicity_other_hispanic_or_latino_description_flag~other_race_national_origin_description_flag~race_other_american_indian_or_alaska_native_description_flag~race_other_asian_description_flag'' AS data_source_integration_columns
     ...
     ON borrower_lending_profile_dim_new_records.data_source_integration_id =
        borrower_lending_profile_dim_etl_start_times.data_source_integration_id
         AND borrower_lending_profile_dim_new_records.max_source_etl_end_date_time >=
             borrower_lending_profile_dim_etl_start_times.etl_start_date_time;', 'Staging DB Connection')
         , ('SP-200007', 1, 'WITH hmda_purchaser_of_loan_dim_incl_new_records AS (
     ...
     ON hmda_purchaser_of_loan_dim_incl_new_records.data_source_integration_id =
        hmda_purchaser_of_loan_dim_etl_start_times.data_source_integration_id
         AND hmda_purchaser_of_loan_dim_incl_new_records.max_source_etl_end_date_time >=
             hmda_purchaser_of_loan_dim_etl_start_times.etl_start_date_time;', 'Staging DB Connection')
         , ('SP-200014', 1, 'WITH loan_junk_dim_new_records AS (
...
JOIN (
    ...
    JOIN star_common.etl_log
     ...
     ON loan_junk_dim_new_records.data_source_integration_id = loan_junk_dim_etl_start_times.data_source_integration_id
         AND loan_junk_dim_new_records.max_source_etl_end_date_time >= loan_junk_dim_etl_start_times.etl_start_date_time;', 'Staging DB Connection')
         , ('SP-200016', 1, 'WITH product_choice_dim_new_records AS (
...
JOIN (
    ...
    JOIN star_common.etl_log
     ...
     ON product_choice_dim_new_records.data_source_integration_id = product_choice_dim_etl_start_times.data_source_integration_id
         AND product_choice_dim_new_records.max_source_etl_end_date_time >= product_choice_dim_etl_start_times.etl_start_date_time;', 'Staging DB Connection')
         , ('SP-200020', 1, 'WITH transaction_junk_dim_new_records AS (
    SELECT ''is_test_loan_flag~structure_code~mi_required_flag~loan_purpose_code~data_source_dwid~piggyback_flag'' AS data_source_integration_columns
         ...
         , MAX( GREATEST( t649.etl_end_date_time, t661.etl_end_date_time ) ) AS max_source_etl_end_date_time
    FROM (
        SELECT <<proposal_partial_load_condition>> AS include_record
             , proposal.*
        FROM history_octane.proposal
...
WITH update_rows (process_name, update_lookup, update_flag) AS (
    VALUES ('SP-200004', 'data_source_dwid', 'N')
         , ('SP-200004', 'ethnicity_collected_visual_or_surname_code', 'N')
         , ('SP-200004', 'ethnicity_refused_code', 'N')
         , ('SP-200004', 'ethnicity_other_hispanic_or_latino_description_flag', 'N')
         , ('SP-200004', 'other_race_national_origin_description_flag', 'N')
         , ('SP-200004', 'race_other_american_indian_or_alaska_native_description_flag', 'N')
         , ('SP-200004', 'race_other_asian_description_flag', 'N')
         , ('SP-200004', 'race_other_pacific_islander_description_flag', 'N')
         , ('SP-200004', 'ethnicity_cuban_flag', 'N')
         , ('SP-200004', 'ethnicity_hispanic_or_latino_flag', 'N')
         , ('SP-200004', 'ethnicity_mexican_flag', 'N')
         , ('SP-200004', 'ethnicity_not_hispanic_or_latino_flag', 'N')
         , ('SP-200004', 'ethnicity_not_obtainable_flag', 'N')
         , ('SP-200004', 'ethnicity_other_hispanic_or_latino_flag', 'N')
         , ('SP-200004', 'ethnicity_puerto_rican_flag', 'N')
         , ('SP-200004', 'race_american_indian_or_alaska_native_flag', 'N')
         , ('SP-200004', 'race_asian_flag', 'N')
         , ('SP-200004', 'race_asian_indian_flag', 'N')
         , ('SP-200004', 'race_black_or_african_american_flag', 'N')
         , ('SP-200004', 'race_chinese_flag', 'N')
         , ('SP-200004', 'race_filipino_flag', 'N')
         , ('SP-200004', 'race_guamanian_or_chamorro_flag', 'N')
         , ('SP-200004', 'race_information_not_provided_flag', 'N')
         , ('SP-200004', 'race_japanese_flag', 'N')
         , ('SP-200004', 'race_korean_flag', 'N')
         , ('SP-200004', 'race_national_origin_refusal_flag', 'N')
         , ('SP-200004', 'race_native_hawaiian_flag', 'N')
         , ('SP-200004', 'race_native_hawaiian_or_other_pacific_islander_flag', 'N')
         , ('SP-200004', 'race_not_applicable_flag', 'N')
         , ('SP-200004', 'race_not_obtainable_flag', 'N')
         , ('SP-200004', 'race_other_asian_flag', 'N')
         , ('SP-200004', 'race_other_pacific_islander_flag', 'N')
         , ('SP-200004', 'race_samoan_flag', 'N')
         , ('SP-200004', 'race_vietnamese_flag', 'N')
         , ('SP-200004', 'race_white_flag', 'N')
         , ('SP-200004', 'sex_female_flag', 'N')
         , ('SP-200004', 'sex_male_flag', 'N')
         , ('SP-200004', 'sex_not_obtainable_flag', 'N')
         , ('SP-200004', 'marital_status_code', 'N')
         , ('SP-200004', 'race_collected_visual_or_surname_code', 'N')
         , ('SP-200004', 'race_refused_code', 'N')
         , ('SP-200004', 'schooling_years', 'N')
         , ('SP-200004', 'sex_collected_visual_or_surname_code', 'N')
         , ('SP-200004', 'sex_refused_code', 'N')
         , ('SP-200006', 'data_source_dwid', 'N')
         , ('SP-200006', 'alimony_child_support_code', 'N')
         , ('SP-200006', 'bankruptcy_code', 'N')
         , ('SP-200006', 'borrowed_down_payment_code', 'N')
         , ('SP-200006', 'citizenship_residency_code', 'N')
         , ('SP-200006', 'disabled_code', 'N')
         , ('SP-200006', 'domestic_relationship_state_code', 'N')
         , ('SP-200006', 'dependents_code', 'N')
         , ('SP-200006', 'homeowner_past_three_years_code', 'N')
         , ('SP-200006', 'homeownership_education_agency_code', 'N')
         , ('SP-200006', 'homeownership_education_code', 'N')
         , ('SP-200006', 'intend_to_occupy_code', 'N')
         , ('SP-200006', 'first_time_homebuyer_flag', 'N')
         , ('SP-200006', 'first_time_homebuyer_auto_compute_flag', 'N')
         , ('SP-200006', 'hud_employee_flag', 'N')
         , ('SP-200006', 'lender_employee_status_confirmed_flag', 'N')
         , ('SP-200006', 'lender_employee_code', 'N')
         , ('SP-200006', 'note_endorser_code', 'N')
         , ('SP-200006', 'obligated_loan_foreclosure_code', 'N')
         , ('SP-200006', 'on_gsa_list_code', 'N')
         , ('SP-200006', 'on_ldp_list_code', 'N')
         , ('SP-200006', 'outstanding_judgements_code', 'N')
         , ('SP-200006', 'party_to_lawsuit_code', 'N')
         , ('SP-200006', 'presently_delinquent_code', 'N')
         , ('SP-200006', 'property_foreclosure_code', 'N')
         , ('SP-200006', 'spousal_homestead_code', 'N')
         , ('SP-200006', 'titleholder_code', 'N')
         , ('SP-200007', 'data_source_dwid', 'N')
         , ('SP-200007', 'code_2017', 'N')
         , ('SP-200007', 'code_2018', 'N')
         , ('SP-200014', 'data_source_dwid', 'N')
         , ('SP-200014', 'buydown_contributor_code', 'N')
         , ('SP-200014', 'fha_program_code', 'N')
         , ('SP-200014', 'hmda_hoepa_status_code', 'N')
         , ('SP-200014', 'durp_eligibility_opt_out_flag', 'N')
         , ('SP-200014', 'fha_principal_write_down_flag', 'N')
         , ('SP-200014', 'hpml_flag', 'N')
         , ('SP-200014', 'lender_concession_candidate_flag', 'N')
         , ('SP-200014', 'mi_required_flag', 'N')
         , ('SP-200014', 'piggyback_flag', 'N')
         , ('SP-200014', 'qm_eligible_flag', 'N')
         , ('SP-200014', 'qualified_mortgage_flag', 'N')
         , ('SP-200014', 'secondary_clear_to_commit_flag', 'N')
         , ('SP-200014', 'student_loan_cash_out_refinance_flag', 'N')
         , ('SP-200014', 'lien_priority_code', 'N')
         , ('SP-200014', 'lqa_purchase_eligibility_code', 'N')
         , ('SP-200014', 'qualified_mortgage_status_code', 'N')
         , ('SP-200014', 'qualifying_rate_code', 'N')
         , ('SP-200014', 'texas_equity_auto_code', 'N')
         , ('SP-200014', 'texas_equity_code', 'N')
         , ('SP-200016', 'data_source_dwid', 'N')
         , ('SP-200016', 'aus_code', 'N')
         , ('SP-200016', 'buydown_schedule_code', 'N')
         , ('SP-200016', 'interest_only_code', 'N')
         , ('SP-200016', 'mortgage_type_code', 'N')
         , ('SP-200016', 'prepay_penalty_schedule_code', 'N')
         , ('SP-200020', 'data_source_dwid', 'N')
         , ('SP-200020', 'piggyback_flag', 'N')
         , ('SP-200020', 'mi_required_flag', 'N')
         , ('SP-200020', 'is_test_loan_flag', 'N')
         , ('SP-200020', 'structure_code', 'N')
         , ('SP-200020', 'loan_purpose_code', 'N')
)
