...
create table mdi.excel_file_input_step
(
	process_name text not null
...
create table mdi.excel_file_input_field
(
...
--
-- Data: insert data for DMI NMLS Call Report load
--
...
INSERT INTO mdi.csv_file_input_field (step_id, row_id, field_name, field_type, field_format, field_length, field_precision, field_currency, field_decimal, field_group, field_trim_type, field_order) VALUES( 1, 5, 'loan_count', 'Integer', '#', -1, -1, '$', '.'
																																																			, ',', 'none', 5);
