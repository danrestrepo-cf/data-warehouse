...
VALUES ( 1, 'SP8.1', 'Load DMI NMLS Call Report to ingress raw table - state' )
;
...
VALUES ( 1, 1, '\input\dmi-V35-state.csv', 'Y', ',', '"', 1024, 'N', 'N', 'N', 'mixed', 'UTF-8', 'N', 'Y', NULL, NULL )
;
...
VALUES ( 1, 1, 'mcr_code', 'String', '', -1, -1, '$', '.', ',', 'none', 1 )
;
...
INSERT
    INTO mdi.csv_file_input_field ( csv_file_input_step_dwid, dwid, field_name, field_type, field_format, field_length
                                  , field_precision
                                  , field_currency, field_decimal, field_group, field_trim_type, field_order )
VALUES ( 1, 2, 'mcr_desc', 'String', '', -1, -1, '$', '.', ',', 'none', 2 )
;
...
INSERT
    INTO mdi.csv_file_input_field ( csv_file_input_step_dwid, dwid, field_name, field_type, field_format, field_length
                                  , field_precision
                                  , field_currency, field_decimal, field_group, field_trim_type, field_order )
VALUES ( 1, 3, 'state_type', 'String', '', -1, -1, '$', '.', ',', 'none', 3 )
;
...
INSERT
    INTO mdi.csv_file_input_field ( csv_file_input_step_dwid, dwid, field_name, field_type, field_format, field_length
                                  , field_precision
                                  , field_currency, field_decimal, field_group, field_trim_type, field_order )
VALUES ( 1, 4, 'unpaid_balance', 'Number', '#', -1, -1, '$', '.', ',', 'none', 4 )
;
...
INSERT
    INTO mdi.csv_file_input_field ( csv_file_input_step_dwid, dwid, field_name, field_type, field_format, field_length
                                  , field_precision
                                  , field_currency, field_decimal, field_group, field_trim_type, field_order )
VALUES ( 1, 5, 'loan_count', 'Integer', '#', -1, -1, '$', '.', ',', 'none', 5 )
;
...
INSERT
    INTO mdi.csv_file_input_field ( csv_file_input_step_dwid, dwid, field_name, field_type, field_format, field_length
                                  , field_precision
                                  , field_currency, field_decimal, field_group, field_trim_type, field_order )
VALUES ( 1, 6, 'avg_loan_size', 'Number', '#', -1, -1, '$', '.', ',', 'none', 6 )
;
...
VALUES ( 1, 1, 'dmi', 'nmls_call_report_state_raw', 1000, NULL, NULL, NULL, NULL, 'N', NULL, 'Y'
...
VALUES ( 1, 1, 'mcr_code', 'mcr_code', 1 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 1, 2, 'mcr_desc', 'mcr_desc', 2 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 1, 3, 'state_type', 'state_type', 3 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 1, 4, 'unpaid_balance', 'unpaid_balance', 4 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 1, 5, 'loan_count', 'loan_count', 5 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 1, 6, 'avg_loan_size', 'avg_loan_size', 6 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 1, 7, 'etl_batch_id', 'etl_batch_id', 7 )
;
...
INSERT
    INTO mdi.process ( dwid, name, description )
VALUES ( 2, 'SP9.1', 'Load DMI NMLS Call Report to ingress raw table - national' )
;
...
INSERT
    INTO mdi.csv_file_input_step ( process_dwid, dwid, filename, header_present, delimiter, enclosure, buffersize
                                 , lazy_conversion, newline_possible, add_filename_result, file_format, file_encoding
                                 , include_filename, process_in_parallel, filename_field, row_num_field )
VALUES ( 2, 2, '\input\dmi-V35-national.csv', 'Y', ',', '"', 1024, 'N', 'N', 'N', 'mixed', 'UTF-8', 'N', 'Y', NULL
       , NULL )
;
...
INSERT
    INTO mdi.csv_file_input_field ( csv_file_input_step_dwid, dwid, field_name, field_type, field_format, field_length
                                  , field_precision
                                  , field_currency, field_decimal, field_group, field_trim_type, field_order )
VALUES ( 2, 7, 'mcr_code', 'String', '', -1, -1, '$', '.', ',', 'none', 1 )
;
...
INSERT
    INTO mdi.csv_file_input_field ( csv_file_input_step_dwid, dwid, field_name, field_type, field_format, field_length
                                  , field_precision
                                  , field_currency, field_decimal, field_group, field_trim_type, field_order )
VALUES ( 2, 8, 'mcr_desc', 'String', '', -1, -1, '$', '.', ',', 'none', 2 )
;
...
INSERT
    INTO mdi.csv_file_input_field ( csv_file_input_step_dwid, dwid, field_name, field_type, field_format, field_length
                                  , field_precision
                                  , field_currency, field_decimal, field_group, field_trim_type, field_order )
VALUES ( 2, 9, 'unpaid_balance', 'String', '', -1, -1, '$', '.', ',', 'none', 3 )
;
...
INSERT
    INTO mdi.csv_file_input_field ( csv_file_input_step_dwid, dwid, field_name, field_type, field_format, field_length
                                  , field_precision
                                  , field_currency, field_decimal, field_group, field_trim_type, field_order )
VALUES ( 2, 10, 'loan_count', 'String', '', -1, -1, '$', '.', ',', 'none', 4 )
;
...
INSERT
    INTO mdi.csv_file_input_field ( csv_file_input_step_dwid, dwid, field_name, field_type, field_format, field_length
                                  , field_precision
                                  , field_currency, field_decimal, field_group, field_trim_type, field_order )
VALUES ( 2, 11, 'avg_loan_size', 'String', '', -1, -1, '$', '.', ',', 'none', 5 )
;
...
INSERT
    INTO mdi.table_output_step ( process_dwid, dwid, target_schema, target_table, commit_size, partitioning_field
                               ...
                               , return_auto_generated_key_field, truncate_table, connectionname, partition_over_tables
                               , specify_database_fields, ignore_insert_errors, use_batch_update )
VALUES ( 2, 3, 'dmi', 'nmls_call_report_national_raw', 1000, NULL, NULL, NULL, NULL, 'N', NULL, 'Y'
...
INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 3, 16, 'mcr_code', 'mcr_code', 1 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 3, 17, 'mcr_desc', 'mcr_desc', 2 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 3, 18, 'unpaid_balance', 'unpaid_balance', 3 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 3, 19, 'loan_count', 'loan_count', 4 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 3, 20, 'avg_loan_size', 'avg_loan_size', 5 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 3, 21, 'etl_batch_id', 'etl_batch_id', 6 )
;
...
INSERT
    INTO mdi.process ( dwid, name, description )
VALUES ( 3, 'SP10.1', 'Load DMI NMLS Call Report to ingress raw table - S540a' )
;
...
VALUES ( 1, 1, 'STATE', 'String', NULL, NULL, -1, '$', '.', ',', 'none', 1 )
;
...
INSERT
    INTO mdi.microsoft_excel_input_field ( microsoft_excel_input_step_dwid, dwid, field_name, field_type, field_format
                                         , field_length, field_precision, field_currency, field_decimal, field_group
                                         , field_trim_type, field_order )
VALUES ( 1, 2, 'ItemId', 'Integer', NULL, NULL, NULL, '$', '.', ',', 'none', 2 )
;
...
INSERT
    INTO mdi.microsoft_excel_input_field ( microsoft_excel_input_step_dwid, dwid, field_name, field_type, field_format
                                         , field_length, field_precision, field_currency, field_decimal, field_group
                                         , field_trim_type, field_order )
VALUES ( 1, 3, 'ServicerID', 'Integer', NULL, NULL, NULL, '$', '.', ',', 'none', 3 )
;
...
INSERT
    INTO mdi.microsoft_excel_input_field ( microsoft_excel_input_step_dwid, dwid, field_name, field_type, field_format
                                         , field_length, field_precision, field_currency, field_decimal, field_group
                                         , field_trim_type, field_order )
VALUES ( 1, 4, 'ServicerName', 'String', NULL, NULL, -1, '$', '.', ',', 'none', 4 )
;
...
INSERT
    INTO mdi.microsoft_excel_input_field ( microsoft_excel_input_step_dwid, dwid, field_name, field_type, field_format
                                         , field_length, field_precision, field_currency, field_decimal, field_group
                                         , field_trim_type, field_order )
VALUES ( 1, 5, 'POOL #', 'String', NULL, NULL, -1, '$', '.', ',', 'none', 5 )
;
...
INSERT
    INTO mdi.microsoft_excel_input_field ( microsoft_excel_input_step_dwid, dwid, field_name, field_type, field_format
                                         , field_length, field_precision, field_currency, field_decimal, field_group
                                         , field_trim_type, field_order )
VALUES ( 1, 6, 'UPB', 'Number', NULL, 17, 2, '$', '.', ',', 'none', 6 )
;
...
INSERT
    INTO mdi.microsoft_excel_input_field ( microsoft_excel_input_step_dwid, dwid, field_name, field_type, field_format
                                         , field_length, field_precision, field_currency, field_decimal, field_group
                                         , field_trim_type, field_order )
VALUES ( 1, 7, 'LoanCount', 'Integer', NULL, NULL, NULL, '$', '.', ',', 'none', 7 )
;
...
INSERT
    INTO mdi.table_output_step ( process_dwid, dwid, target_schema, target_table, commit_size, partitioning_field
                               ...
                               , return_auto_generated_key_field, truncate_table, connectionname, partition_over_tables
                               , specify_database_fields, ignore_insert_errors, use_batch_update )
VALUES ( 3, 2, 'dmi', 'nmls_call_report_s540a_raw', 1000, NULL, NULL, NULL, NULL, 'N', NULL, 'Y'
       , 'Ingress DB Connection', 'N', 'Y', 'N', 'N' )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 2, 8, 'state_type', 'STATE', 1 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 2, 9, 'item_id', 'ItemId', 2 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 2, 10, 'servicer_id', 'ServicerID', 3 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 2, 11, 'servicer_name', 'ServicerName', 4 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 2, 12, 'pool_number', 'POOL #', 5 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 2, 13, 'unpaid_balance', 'UPB', 6 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 2, 14, 'loan_count', 'LoanCount', 7 )
;

INSERT
    INTO mdi.table_output_field ( table_output_step_dwid, dwid, database_field_name, database_stream_name, field_order )
VALUES ( 2, 15, 'etl_batch_id', 'etl_batch_id', 8 )
;
