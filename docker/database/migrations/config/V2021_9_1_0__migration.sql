--
-- EDW | loan_fact ETL: update joins to unique dimensions to account for null values in all joining fields
-- https://app.asana.com/0/0/1200866427041074
--
...
FROM
    ...
    LEFT JOIN star_loan.product_choice_dim ON loan.l_aus_type IS NOT DISTINCT FROM product_choice_dim.aus_code
        ...
        AND loan.l_prepay_penalty_schedule_type IS NOT DISTINCT FROM product_choice_dim.prepay_penatly_schedule_code
