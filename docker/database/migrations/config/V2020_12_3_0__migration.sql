...
INSERT INTO mdi.table_output_step ( dwid, process_dwid, target_schema, target_table, commit_size, partitioning_field
                                  ...
                                  , use_batch_update )
VALUES ( 5, 5, 'staging_compliance', 'nmls_call_report_state', 1000, NULL, NULL, NULL, NULL, 'N', NULL, 'Y', 'Staging DB Connection'::mdi.PENTAHO_DB_CONNECTION_NAME
       , 'N', 'Y', 'N', 'N' )
;
...
INSERT INTO mdi.table_output_step ( dwid, process_dwid, target_schema, target_table, commit_size, partitioning_field
                                  ...
                                  , connectionname, partition_over_tables, specify_database_fields, ignore_insert_errors
                                  , use_batch_update )
VALUES ( 4, 4, 'staging_compliance', 'nmls_call_report_national', 1000, NULL, NULL, NULL, NULL, 'N', NULL, 'Y', 'Staging DB Connection'::mdi.PENTAHO_DB_CONNECTION_NAME
       , 'N', 'Y', 'N', 'N' )
;
...
INSERT INTO mdi.table_output_step ( dwid, process_dwid, target_schema, target_table, commit_size, partitioning_field
                                  ...
                                  , connectionname, partition_over_tables, specify_database_fields, ignore_insert_errors
                                  , use_batch_update )
VALUES ( 6, 6, 'staging_compliance', 'nmls_call_report_s540a', 1000, NULL, NULL, NULL, NULL, 'N', NULL, 'Y', 'Staging DB Connection'::mdi.PENTAHO_DB_CONNECTION_NAME
       , 'N', 'Y', 'N', 'N' )
;
