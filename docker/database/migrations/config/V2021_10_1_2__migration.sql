...
-- Rename field lh_lender_concession_remaining_amount to lh_general_lender_concessions_amount_non_itemized

-- edw_field_definition records
UPDATE mdi.edw_field_definition
    SET field_name = 'lh_general_lender_concessions_amount_non_itemized'
    WHERE field_name = 'lh_lender_concession_remaining_amount';

-- table_output_field record
UPDATE mdi.table_output_field
    SET database_stream_name = 'lh_general_lender_concessions_amount_non_itemized'
        , database_field_name = 'lh_general_lender_concessions_amount_non_itemized'
    WHERE dwid = (
        ...
        FROM mdi.table_output_step
            JOIN mdi.table_output_field ON table_output_step.dwid = table_output_field.table_output_step_dwid
                AND table_output_field.database_field_name = 'lh_lender_concession_remaining_amount'
        );

-- table_input_step record
UPDATE mdi.table_input_step
    SET sql = '--finding records to insert into history_octane.loan_hedge
    ...
    WHERE dwid = (
        ...
        FROM mdi.process
            ...
            JOIN mdi.table_output_step ON process.dwid = table_output_step.process_dwid
                AND table_output_step.target_table = 'loan_hedge'
        );
