...
WITH new_staging_table_definitions AS (
   ...
   , new_fields (schema_name, table_name, field_name, data_type, field_order) AS (
    VALUES ('staging_octane', 'company_license_contact', 'cmlc_pid', 'BIGINT', NULL)
         ...
         , ('staging_octane', 'company_license_contact', 'cmlc_lender_user_pid', 'INTEGER', NULL)
         , ('staging_octane', 'company_license_contact', 'cmlc_company_license_pid', 'INTEGER', NULL)
         , ('staging_octane', 'company_license_contact', 'cmlc_from_date', 'INTEGER', NULL)
         , ('staging_octane', 'company_license_contact', 'cmlc_through_date', 'INTEGER', NULL)
         , ('history_octane', 'company_license_contact', 'cmlc_pid', 'BIGINT', 1)
         , ('history_octane', 'company_license_contact', 'cmlc_version', 'INTEGER', 2)
         , ('history_octane', 'company_license_contact', 'cmlc_lender_user_pid', 'INTEGER', 3)
         , ('history_octane', 'company_license_contact', 'cmlc_company_license_pid', 'INTEGER', 4)
         , ('history_octane', 'company_license_contact', 'cmlc_from_date', 'INTEGER', 5)
         , ('history_octane', 'company_license_contact', 'cmlc_through_date', 'INTEGER', 6)
